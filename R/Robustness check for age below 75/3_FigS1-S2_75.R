...
pdf(file="R/Robustness check for age below 75/Figure_S1_males_75.pdf",width=17,height=9,useDingbats = F)
FigS1
dev.off()
...
pdf(file="R/Robustness check for age below 75/Figure_S2_females_75.pdf",width=17,height=9,useDingbats = F)
FigS2
dev.off()
